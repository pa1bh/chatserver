...
> **⚠️ Warning**
>
> This is a proof of concept / test project. The code is largely generated by LLMs (Claude Opus 4.5 and gpt-5.1-codex-max). Only use this on trusted networks.

Real-time chat server with a Bun/Express frontend and high-performance Rust WebSocket backend and an AI integration using OpenRouter.ai, because ... AI.
